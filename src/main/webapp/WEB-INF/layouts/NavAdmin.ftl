...
<#assign navLinks = [
	...
	{ "label":"Reparticion",
		...
		"subNav": [
			...
			{ "URL":"departments/department/hierarchicalAccumulatedCredits",   "label":"Creditos Retenidos Acumulados",         "requiresDepartment":true, "doDisplay":account?exists && account.hasPermissions("Department_Info", "UPDATE") }
		]
	},
	{ "label":"Movimientos",
