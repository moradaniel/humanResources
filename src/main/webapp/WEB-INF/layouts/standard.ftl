...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="${requestContext.contextPath}/resources/javascript/angularjs/vendors/ui-select/0.19.5/dist/select.css"/>
...
function isUserBrowserInternetExplorer() {
	...
	<script type="text/javascript" src="${requestContext.contextPath}/resources/javascript/angularjs/angular-1.5.8/angular.js"></script>
	<!-- script type="text/javascript" src="${requestContext.contextPath}/resources/javascript/angularjs/angular-1.5.8/i18n/angular-locale_es-ar.js"></script -->
	...
	<script type="text/javascript" src="${requestContext.contextPath}/resources/javascript/angularjs/angular-1.5.8/angular-resource.js"></script>
	<script type="text/javascript" src="${requestContext.contextPath}/resources/javascript/angularjs/angular-1.5.8/angular-route.js"></script>
	<script type="text/javascript" src="${requestContext.contextPath}/resources/javascript/angularjs/angular-1.5.8/angular-sanitize.js"></script>
	...
	<script type="text/javascript" src="${requestContext.contextPath}/resources/javascript/angularjs/vendors/ui-select/0.19.5/dist/select.js"></script>
